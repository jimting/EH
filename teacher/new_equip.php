...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<h1>請填入器材之資料</h1>
			<form action="new_equip_finish.php" method="post">
				<br><br>
				名稱:<input type="text" name="equip_name">
				<br><br>
				數量:<input type="text" name="equip_quantity">
				<br><br>
				日期:<input type="text" name="equip_date">
				<br><br>
